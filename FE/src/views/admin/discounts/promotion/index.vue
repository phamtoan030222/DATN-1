      ...
      <NGrid :cols="24" :x-gap="24" :y-gap="16">
        ...
        <NGridItem :span="2">
          <NFormItem label="&nbsp;"> 
            ...
            >
              <template #icon>
                <NIcon size="20"><Icon icon="carbon:rotate" /></NIcon>
              </template>
            </NButton>
          </NFormItem>
        </NGridItem>
...
import {
  ...
  NInput, NInputNumber, NGrid, NGridItem,
  NTag, NPagination, NIcon, useMessage,
  DataTableColumns, NDatePicker, NRadioGroup, NRadio
} from "naive-ui";
...
async function fetchDiscounts() {
  ...
  try {
    const params: ParamsGetDiscount = {
      page: 1, size: 1000, sortBy: searchForm.sortBy,
    };
