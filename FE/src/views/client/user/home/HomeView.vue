...
<<<<<<< HEAD
  NCard,
=======
>>>>>>> aba0668051f8ca049861108138e9cd60aa6d9c53
  NCarousel,
  NEmpty,
  NSpin,
} from 'naive-ui'
...
</style>          class="bg-white rounded-2xl p-4 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 cursor-pointer border border-gray-100 relative group flex flex-col h-full"
          @click="handleClickProduct(item.id)"
        >
          <div v-if="(item.percentage ?? 0) > 0" class="absolute top-3 right-3 z-10 bg-red-500 text-white text-[10px] font-bold px-2 py-0.5 rounded-full shadow-sm">
            -{{ item.percentage }}%
