...
export async function getAllOperatingSystems(params: ParamsGetOperatingSystem) {
...
export async function updateOperatingSystemStatus(id: string, status: 'ACTIVE' | 'INACTIVE') {
  return request({
...
export async function createOperatingSystem(payload: CreateOperatingSystemRequest) {
  return request({
...
export async function updateOperatingSystem(id: string, payload: CreateOperatingSystemRequest) {
  return request({
