...
export const getAllOperatingSystems = async (
  params: ParamsGetOperatingSystem
) => {
...
export const updateOperatingSystemStatus = async (
  id: string,
...
export const createOperatingSystem = async (
  payload: CreateOperatingSystemRequest
) => {
  return request({
...
export const updateOperatingSystem = async (
  id: string,
  payload: CreateOperatingSystemRequest
) => {
  return request({
