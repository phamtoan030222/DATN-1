...
export async function getGHNProvinces(token: string) {
  try {
...
export async function getGHNDistricts(provinceId: number | null, token: string) {
  try {
...
export async function getGHNWards(districtId: number, token: string) {
  try {
...
export async function calculateFee(myRequest: ShippingFeeRequest, token: string, shopId: number) {
  try {
    const body = {
...
export async function getAvailableServices(token: string, requestBody: GHNAvailableServiceRequest) {
  try {
