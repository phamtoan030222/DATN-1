...
public interface ClientProductNotApplyRepositoryProduct extends ProductDiscountDetailRepository {
    @Query(value = """
        SELECT pd.id AS id,
        ...
        """)
    Page<ClientProductDetailResponse> getAllNotAppliedProductsByDiscount(Pageable pageable,
