...
import com.sd20201.datn.core.client.products.productdetail.repository.ClientPDImeiRepository;
import com.sd20201.datn.core.client.products.productdetail.repository.ClientPDMaterialRepository;
import com.sd20201.datn.core.client.products.productdetail.repository.ClientPDOperatingSystemRepository;
...
import com.sd20201.datn.core.client.products.productdetail.repository.ClientPDProductRepository;
...
public class ClientProductDetailServiceImpl implements ClientProductDetailService {
    ...
    private final ClientPDHardDriveRepository hardDriveRepository;

    private final ClientPDColorRepository colorRepository;

    private final ClientPDImeiRepository imeiRepository;

    private final ClientPDRAMRepository ramRepository;

    private final ClientPDMaterialRepository materialRepository;

    private final ClientPDCPURepository cpuRepository;

    private final ClientPDGPURepository gpuRepository;

    private final ClientPDProductRepository productRepository;

    private final CloudinaryService cloudinaryService;

    private final ImageProductRepository imageProductRepository;

    private final ClientPDOperatingSystemRepository operatingSystemRepository;

    private final ClientPDScreenRepository screenRepository;

    private final ClientPDBatteryRepository batteryRepository;
    ...
    @Override
    public ResponseObject<?> modify(ClientPDProductDetailCreateUpdateRequest request) {
    ...
    @Override
    public ResponseObject<?> update(ClientPDProductDetailCreateUpdateRequest request) {
    ...
    @Override
    public ResponseObject<?> createVariant(String idProduct, ClientPDVariantRequest variant) {
    ...
    @Override
    public ResponseObject<?> checkExistVariant(ClientPDExistVariantRequest request) {
        return ResponseObject.successForward(
